<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangmufengmian" label="项目封面" prop="xiangmufengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xiangmufengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="项目视频" prop="xiangmushipin">
          <file-upload
          tip="点击上传项目视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangmushipin" label="项目视频" prop="xiangmushipin">
            <el-button type="text" size="small" @click="download(ruleForm.xiangmushipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="收费标准" prop="shoufeibiaozhun">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shoufeibiaozhun" label="收费标准" prop="shoufeibiaozhun">
                    <span>{{ruleForm.shoufeibiaozhun}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshishu = true;
          ...
          if(o=='xiangmushipin'){
            this.ruleForm.xiangmushipin = obj[o];
	    this.ro.xiangmushipin = true;
            continue;
          }
          if(o=='xiangqing'){
