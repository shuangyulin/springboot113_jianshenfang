<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.huiyuankatupian" label="会员卡图片" prop="huiyuankatupian">
          <file-upload
          tip="点击上传会员卡图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.huiyuankatupian" label="会员卡图片" prop="huiyuankatupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.huiyuankatupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员卡价格" prop="huiyuankajiage">
          <el-input v-model="ruleForm.huiyuankajiage" 
              placeholder="会员卡价格" clearable  :readonly="ro.huiyuankajiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员卡价格" prop="huiyuankajiage">
              <el-input v-model="ruleForm.huiyuankajiage" 
                placeholder="会员卡价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huiyuankagongneng" label="会员卡功能" prop="huiyuankagongneng">
                    <span>{{ruleForm.huiyuankagongneng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
