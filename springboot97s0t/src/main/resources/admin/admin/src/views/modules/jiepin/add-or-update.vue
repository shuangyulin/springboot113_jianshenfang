<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="解聘编号" prop="jiepinbianhao">
            <el-input v-model="ruleForm.jiepinbianhao" 
                placeholder="解聘编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiepinbianhao" label="解聘编号" prop="jiepinbianhao">
              <el-input v-model="ruleForm.jiepinbianhao" 
                placeholder="解聘编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教练类型" prop="jiaolianleixing">
          <el-input v-model="ruleForm.jiaolianleixing" 
              placeholder="教练类型" clearable  :readonly="ro.jiaolianleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教练类型" prop="jiaolianleixing">
              <el-input v-model="ruleForm.jiaolianleixing" 
                placeholder="教练类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教练价格" prop="jiaolianjiage">
          <el-input v-model="ruleForm.jiaolianjiage" 
              placeholder="教练价格" clearable  :readonly="ro.jiaolianjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教练价格" prop="jiaolianjiage">
              <el-input v-model="ruleForm.jiaolianjiage" 
                placeholder="教练价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="解聘时间" prop="jiepinshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiepinshijian" label="解聘时间" prop="jiepinshijian">
              <el-input v-model="ruleForm.jiepinshijian" 
                placeholder="解聘时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiepinyuanyin" label="解聘原因" prop="jiepinyuanyin">
                    <span>{{ruleForm.jiepinyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
